...
PREM_GATEWAY_AUTH_ROOT_ADMIN_USER=$BASIC_AUTH_USER
PREM_GATEWAY_AUTH_ROOT_ADMIN_PASS=$BASIC_AUTH_PASS
export PREM_GATEWAY_AUTH_ROOT_API_KEY
export PREM_GATEWAY_AUTH_ROOT_ADMIN_USER
export PREM_GATEWAY_AUTH_ROOT_ADMIN_PASS
